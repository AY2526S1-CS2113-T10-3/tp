    ...
    public class Parser {
        ...
        private static Command parseReviewCommand(String command) throws UniflowException {
            ...
            if (parts.length < 2) throw new UniflowException("Usage: review COURSE_NAME");
        ...
        private static Command parseAddReviewCommand(String command) throws UniflowException {
            ...
            String course = null, user = null, text = null;
            for (String part : parts) {
                if (part.startsWith("c/")) course = part.substring(2);
                else if (part.startsWith("u/")) user = part.substring(2);
                else if (part.startsWith("r/")) text = part.substring(2);
            }
